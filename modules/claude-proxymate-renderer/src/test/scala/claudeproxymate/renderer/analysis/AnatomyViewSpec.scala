...
object AnatomyViewSpec extends Properties {
  ...
  private val labels = AnatomyLabels(
    costTitle = "Cost",
    attributionTitle = "Attribution (est.)",
    structureTitle = "Structure",
    inventoryTitle = "Inventory",
    anomaliesTitle = "Diagnostics",
    estimatedTag = "est.",
    noResponseNote = "No response captured",
    lblMessages = "Messages",
    lblTurns = "Turns",
    lblSystemBlocks = "system[]",
    lblTools = "Tools",
    lblToolUse = "tool_use",
    lblToolResult = "tool_result",
    lblImages = "Images",
